...
type TTFB struct {
	...
	P999Millis        int      `json:"p999_millis"`
...
func (t TTFB) String() string {
	...
	return fmt.Sprintf("Avg: %v, Best: %v, 25th: %v, Median: %v, 75th: %v, 90th: %v, 99th: %v, 99.9th: %v, Worst: %v StdDev: %v",
		...
		time.Duration(t.P999Millis)*time.Millisecond,
